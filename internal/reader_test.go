	...
	executeReaderTests(t, []readerTestCase{
		{
			...
			src:  "    +1234",
			want: internal.Int64(1234),
		},
		{
			name: "PositiveInt",
			src:  "+1245",
			want: internal.Int64(1245),
		},
		{
			name: "NegativeInt",
			src:  "-234",
			want: internal.Int64(-234),
		},
		{
			name: "PositiveFloat",
			src:  "+1.334",
			want: internal.Float64(1.334),
		},
		{
			name: "NegativeFloat",
			src:  "-1.334",
		...
		},
		{
			...
			src:  "1e10",
			want: internal.Float64(1e10),
		},
		{
			name: "ScientificNegativeExponent",
			src:  "1e-10",
			want: internal.Float64(1e-10),
		},
		{
			name: "ScientificWithDecimal",
			src:  "1.5e10",
			want: internal.Float64(1.5e+10),
		},
		{
			name:    "FloatStartingWith0",
			src:     "012.3",
			want:    internal.Float64(012.3),
			wantErr: false,
		},
		{
			name:    "InvalidValue",
...
func TestReader_One_Set(t *testing.T) {
	executeReaderTests(t, []readerTestCase{
		...
		},
		{
			...
			src:  "#{1 2 []}",
			want: internal.Set{
				Values: []internal.Value{internal.Int64(1),
					internal.Int64(2),
					internal.Vector{
						Position: internal.Position{
							File:   "<string>",
